...
server.tool(
    "amm-bid",
    "Bid on an Automated Market Maker's auction slot for discounted trading fees",
    {
        fromSeed: z
            .string()
            .optional()
        ...
        authAccounts: z
            .array(
                z
                    .string()
                    .describe(
                        "Account address to authorize for discounted trading"
                    )
            )
            .max(4)
            .optional()
            .describe(
                "Up to 4 additional accounts to authorize for discounted trading"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
...
server.tool(
    "check-cancel",
    "Cancel an unredeemed Check, removing it from the ledger without sending any money",
    {
        fromSeed: z
            .string()
            .optional()
...
server.tool(
    ...
    "Claw back tokens issued by your account",
    {
        ...
        amount: z
            ...
            .describe(
                "The amount being clawed back and the holder from which to claw back"
            ),
        holder: z
            .string()
            .optional()
            .describe(
                "(Optional) Specifies the holder's address from which to claw back an MPToken"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
        ...
        try {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Error performing clawback: ${
                            error instanceof Error
                                ? error.message
                                : String(error)
                        }`,
...
server.tool(
    "escrow-cancel",
    "Cancel an escrow and return escrowed XRP to the sender",
    {
        fromSeed: z
            .string()
            .optional()
...
server.tool(
    "escrow-create",
    "Create an escrow on the XRP Ledger to lock up XRP until specific conditions are met",
    {
        fromSeed: z
            .string()
            .optional()
        ...
        destination: z
            .string()
            .describe(
                "Address of the account that should receive the escrowed XRP"
            ),
        ...
        finishAfter: z
            ...
            .optional()
            .describe(
                "The time, in seconds since the Ripple Epoch, after which the escrow can be finished"
            ),
        cancelAfter: z
            .number()
            .optional()
            .describe(
                "The time, in seconds since the Ripple Epoch, after which the escrow can be cancelled"
            ),
        condition: z
            .string()
            .optional()
            .describe(
                "Hex-encoded PREIMAGE-SHA-256 crypto-condition which must be fulfilled to execute the escrow"
            ),
        destinationTag: z
            .number()
            .optional()
            .describe(
                "Destination tag to specify the beneficiary or purpose at the destination account"
            ),
        sourceTag: z
            .number()
            .optional()
            .describe(
                "Source tag to identify the source or purpose of this escrow"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
    ...
    async ({
        ...
        try {
            ...
            if (!finishAfter && !condition) {
                throw new Error(
                    "Either finishAfter or condition must be provided for an escrow"
                );
            }
...
server.tool(
    "escrow-finish",
    "Finish an escrow and release the escrowed XRP to the recipient",
    {
        fromSeed: z
            .string()
            .optional()
        ...
        fulfillment: z
            ...
            .optional()
            .describe(
                "Hex-encoded fulfillment of the crypto-condition held in the escrow"
            ),
        condition: z
            .string()
            .optional()
            .describe(
                "Hex-encoded crypto-condition. Required when fulfilling a time-based escrow with a crypto-condition"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
...
server.tool(
    "ledger-state-fix",
    "Fix specific issues affecting the XRP Ledger",
    {
        fromSeed: z
            .string()
            .optional()
        ...
        ledgerFixType: z
            .number()
            .describe(
                "The type of fix to apply. Currently only type 1 is supported (fixes NFToken directory)"
            ),
        owner: z
            .string()
            .optional()
            .describe(
                "The account that owns the NFToken directory to fix (required if ledgerFixType is 1)"
            ),
        fee: z
            .string()
            .optional()
    ...
    async ({ fromSeed, ledgerFixType, owner, fee, useTestnet }) => {
        ...
        try {
            ...
            if (ledgerFixType !== 1) {
                throw new Error(
                    "Currently only ledgerFixType 1 (fix NFToken directory) is supported"
                );
            }

            if (ledgerFixType === 1 && !owner) {
                throw new Error(
                    "Owner parameter is required when ledgerFixType is 1"
                );
            }

            // Create LedgerStateFix transaction
            const ledgerStateFixTx: any = {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Error fixing ledger state: ${
                            error instanceof Error
                                ? error.message
                                : String(error)
                        }`,
...
server.tool(
    "offer-cancel",
    "Cancel an existing offer on the XRP Ledger",
    {
        fromSeed: z
            .string()
            .optional()
...
server.tool(
    "offer-create",
    "Create an offer to exchange currencies on the XRP Ledger",
    {
        fromSeed: z
            .string()
            .optional()
        ...
        takerGets: z
            .object({
                currency: z
                    .string()
                    .describe(
                        "Currency code (e.g., 'XRP' or 3-character code)"
                    ),
                issuer: z
                    .string()
                    .optional()
        ...
        expiration: z
            ...
            .optional()
            .describe(
                "Time after which the offer expires (in seconds since Ripple Epoch)"
            ),
        offerSequence: z
            .number()
            .optional()
        ...
        passive: z
            ...
            .optional()
            .describe(
                "If true, offer does not consume offers that exactly match it"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
...
server.tool(
    "oracle-delete",
    "Delete an existing price oracle on the XRP Ledger",
    {
        fromSeed: z
            .string()
            .optional()
...
server.tool(
    ...
    "Create a payment channel to another account on the XRP Ledger",
    {
        fromSeed: z
            .string()
            .optional()
        ...
        destination: z
            .string()
            .describe(
                "Address of the account to receive XRP payments through this channel"
            ),
        amount: z
            .string()
        ...
        settleDelay: z
            .number()
            .describe(
                "Number of seconds the destination must wait to claim XRP after requesting channel closure"
            ),
        publicKey: z
            .string()
            .optional()
            .describe(
                "Public key to use for signing claims against this channel. If omitted, uses ephemeral key pair"
            ),
        cancelAfter: z
            .number()
            .optional()
            .describe(
                "Time after which the channel closes automatically (in seconds since Ripple Epoch)"
            ),
        destinationTag: z
            .number()
            .optional()
    ...
    async ({
        ...
        try {
            ...
            const paymentChannelCreateTx: any = {
            ...
            if (
                ...
                for (const node of affectedNodes) {
                    if (
                        (node as any).CreatedNode &&
                        (node as any).CreatedNode.LedgerEntryType ===
                            "PayChannel"
                    ) {
                        channelID = (node as any).CreatedNode.LedgerIndex;
                        break;
                    }
                }
            }
...
server.tool(
    ...
    "Claim XRP from a payment channel or request to close it",
    {
        ...
        balance: z
            ...
            .optional()
            .describe(
                "Total amount of XRP delivered by this channel after processing this claim"
            ),
        signature: z
            .string()
            .optional()
            .describe(
                "Signature authorizing the claim (required if claiming as destination)"
            ),
        publicKey: z
            .string()
            .optional()
        ...
        renew: z
            ...
            .optional()
            .describe(
                "Request to extend the channel's expiration (source account only)"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
    ...
    async ({
        ...
        try {
            ...
            const paymentChannelClaimTx: any = {
...
server.tool(
    ...
    "Create, replace, or remove a list of signers that can be used to multi-sign a transaction",
    {
        ...
        signerQuorum: z
            .number()
            .describe(
                "Target number for signer weights. Use 0 to delete the signer list"
            ),
        signerEntries: z
            .array(
                z.object({
            ...
            .optional()
            .describe(
                "Array of signers and their weights (omit when deleting)"
            ),
        fee: z.string().optional().describe("Transaction fee in XRP"),
        useTestnet: z
            .boolean()
    ...
    async ({ fromSeed, signerQuorum, signerEntries, fee, useTestnet }) => {
        ...
        try {
            ...
            if (
                ...
                throw new Error(
                    "When deleting a signer list (signerQuorum = 0), signerEntries must be omitted"
                );
            }
            ...
            if (
                ...
                throw new Error(
                    "When creating a signer list, signerEntries must be provided"
                );
            }
            ...
            if (signerEntries) {
                for (const entry of signerEntries) {
                    ...
                    if (entry.account === wallet.address) {
                        throw new Error(
                            "Account submitting the transaction cannot appear in the signer list"
                        );
                    }
                }
                ...
                if (signerQuorum > totalWeight) {
                    throw new Error(
                        `SignerQuorum (${signerQuorum}) cannot be greater than total weights (${totalWeight})`
                    );
                }
            }

            // Create SignerListSet transaction
            const signerListSetTx: any = {
            ...
            try {
                ...
                if (signerQuorum > 0 && status === "success") {
                    ...
                    if (
                        signerListResponse.result.account_objects &&
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Error setting signer list: ${
                            error instanceof Error
                                ? error.message
                                : String(error)
                        }`,
    ...
    async ({ fromSeed, ticketCount, fee, useTestnet }) => {
        ...
        try {
            ...
            if (currentTicketCount + ticketCount > 250) {
                throw new Error(
                    `Cannot create ${ticketCount} tickets: would exceed the limit of 250 (current count: ${currentTicketCount})`
                );
            }

            // Create TicketCreate transaction
            const ticketCreateTx: any = {
            ...
            if (
                ...
                for (const node of affectedNodes) {
                    if (
                        (node as any).CreatedNode &&
                        (node as any).CreatedNode.LedgerEntryType === "Ticket"
                    ) {
                        ticketIDs.push((node as any).CreatedNode.LedgerIndex);
                    }
                }
            }
                        ...
                        text: JSON.stringify(
                            {
                                ...
                                ticketIDs,
                                newSequence:
                                    updatedAccountInfo.result.account_data
                                        .Sequence,
                                updatedTicketCount:
                                    updatedAccountInfo.result.account_data
                                        .TicketCount || 0,
...
server.tool(
    ...
    "Create or modify a trust line linking two accounts",
    {
        ...
        qualityIn: z
            ...
            .optional()
            .describe(
                "Value incoming balances at the ratio of this number per 1,000,000,000 units"
            ),
        qualityOut: z
            .number()
            .optional()
            .describe(
                "Value outgoing balances at the ratio of this number per 1,000,000,000 units"
            ),
        setAuth: z
            .boolean()
            .optional()
        ...
        setNoRipple: z
            ...
            .optional()
            .describe(
                "Enable the No Ripple flag, which blocks rippling between trust lines"
            ),
        clearNoRipple: z
            .boolean()
            .optional()
    ...
    async ({
        ...
        try {
            ...
            if (setNoRipple && clearNoRipple) {
                throw new Error(
                    "Cannot set and clear the NoRipple flag at the same time"
                );
            }

            if (setFreeze && clearFreeze) {
                throw new Error(
                    "Cannot set and clear the Freeze flag at the same time"
                );
            }

            if (setDeepFreeze && clearDeepFreeze) {
                throw new Error(
                    "Cannot set and clear the DeepFreeze flag at the same time"
                );
            }
...
server.tool(
    ...
    async ({
        ...
        try {
            ...
            let uriHex: string | undefined = undefined;
            if (uri) {
            ...
            if (
                ...
                for (const node of affectedNodes) {
                    if (
                        (node as any).ModifiedNode &&
                        (node as any).ModifiedNode.LedgerEntryType ===
                            "NFTokenPage" &&
                        (node as any).ModifiedNode.FinalFields &&
                        (node as any).ModifiedNode.FinalFields.NFTokens
                    ) {
                        const previousTokens = (
                            (node as any).ModifiedNode.PreviousFields
                                ?.NFTokens || []
